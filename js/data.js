...
G.C = {
  ...
  /* --- 글자 생성 ---
     60초에서 한 번에 2초씩 줄인다. (예전 50→48→46 과 같은 폭 —
     세 번 단축하면 54초.) 생성 게이지·빈 보드를 두드리면 이번 대기만 조금 당긴다. */
  SPAWN_STEPS: [60, 58, 56, 54, 52, 50, 48, 46, 44, 42, 40, 38, 36, 34, 32],
  ...
  SPAWN_CLICK_CUT: 0.2,  // 빈 곳을 한 번 두드리면 이번 대기에서 깎는 초
  SPAWN_CLICK_GAP: 0.1,  // 연타 하한 (초) — 이보다 빠른 입력은 무시
  ...
  BOX_PER_LETTER: 5,     // 넣은 낱글자 하나가 20초마다 쌓는 값
