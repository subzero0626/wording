  ...
  Entity.prototype.update = function (dt) {
    ...
    if (this.jump) {
      ...
      if (this.vx || this.vy) {
        ...
        this.x += this.vx * dt;
        this.y += this.vy * dt;
        var dampBase = (G.skin && G.skin.motionDamp) ? G.skin.motionDamp() : 0.90;
        var damp = Math.pow(dampBase, dt * 60);
        this.vx *= damp; this.vy *= damp;
        var stop = (G.skin && G.skin.id && G.skin.id() === 'space') ? 0.6 : 1.5;
